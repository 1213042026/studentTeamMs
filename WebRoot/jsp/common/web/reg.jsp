				...
				<form id="regUser" accept-charset="utf-8"
					...
					<ul class="reg_form" id="reg-ul">
						...
						<li><label for="passwd2" class="input-tips2">确认密码：</label>
							<div class="inputOuter2">
								<input type="password" name="user.newPassword" maxlength="16"
									class="inputstyle2" />
							</div></li>
						...
						<input type="hidden" name="user.user_type" maxlength="10" class="inputstyle2"/>
