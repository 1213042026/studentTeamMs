...
<html>
 ...
 <body>
  ...
  <div class="header">
      ...
      <div class="dl-title">
          <span class="lp-title-port">欢迎进入部门管理</span><span class="dl-title-text">系统</span>
      </div>
   ...
   <div class="content">
    <div class="dl-main-nav">
      ...
      <ul id="J_Nav"  class="nav-list ks-clear">
        ...
        <li class="nav-item"><div class="nav-item-inner nav-supplier">部门浏览</div></li>
      ...
      var config = [{
          ...
          menu:[{
            ...
            menu:[{
                text:'部门浏览',
                items:[
                  {id:'code',text:'所有部门',href:'community!main_listCommunity.action'},
                ]
              },]
          },{
            id:'search',
