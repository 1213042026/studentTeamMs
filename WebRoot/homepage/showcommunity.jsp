...
<head>
	...
	<script src="admin/js/communityDetails.js" type="text/javascript"></script>
</head>
<body>
<header>
    <div class="inner">
        ...
        <nav>
            <ul class="list-none" id="list-none">
                ...
                <li class="line"></li>
                <li id='nav_3' style='width:121px;' class='navdown'><a href='community.jsp' class='hover-none nav'><span>部门浏览</span></a>
                </li>
                <li class="line"></li>
                <li id='nav_4' style='width:121px;'><a href='activity.jsp' class='hover-none nav'><span>部门活动</span></a>
                </li>
                <li class="line"></li>
...
<div class="inner met_flash">
    <div class="flash">
        <a href='#' target='_blank' title='部门管理系统'></a>
    </div>
</div>
...
<div class="sidebar inner">
    <div class="sb_nav">
        ...
        <h3 class='title myCorner' data-corner='top 5px'>部门浏览</h3>
        <div class="active" id="sidebar" data-csnow="2" data-class3="0" data-jsok="2">
            <dl class="list-none navnow">
                <dt id='part2_4'><a href='./community.jsp' title='所有部门' class="zm"><span>所有部门</span></a></dt>
            </dl>
            <div class="clear"></div>
        </div>
    ...
    <div class="sb_box">
        <h3 class="title">
            <div class="position">当前位置：<a href="index.jsp" title="网站首页">网站首页</a> &gt; <a href=./community.jsp>部门浏览</a>
                > <a href="#">部门详情</a></div>
            <span>部门详情</span>
        </h3>
        <div class="clear"></div>
        ...
        <div class="active" id="shownews" align="center">
            ...
            <table class="table_list" width="780px">
                ...
                <tr>
                    ...
                    <td style="display: table-cell" align="left">
                        <li class='list top' id="cmnt_proper_name"></li>
                    </td>
                </tr>
                <tr>
                    <td style="display: table-cell" align="left">
                        <li class='list top' id="cmnt_intro"></li>
                    </td>
                    <td></td>
                </tr>
            </table>
            <div style="margin: 20px">
                <img id="cmnt_img" img='' alt="图片关键词" title="图片关键词"
                     style="width:500px; height:300px; "/>
                <div style="margin-top: 20px">
                	<h3 style="margin: 10px;">加入我们</h3>
                	<textarea rows="3" cols="76" id="apply_textarea">申请加入理由</textarea>
                    <button class="button white" id="apply_button" style="margin: 10px;">点击加入</button>
                </div>
            </div>
