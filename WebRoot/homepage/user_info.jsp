    ...
    <div class="inner">
        ...
        <nav>
            <ul class="list-none" id="list-none">
                ...
                <li class="line"></li>
                <li id='nav_3' style='width:121px;'><a href='community.jsp' class='hover-none nav'><span>部门浏览</span></a>
                </li>
                <li class="line"></li>
    ...
    <div class="sb_nav">
        ...
        <div class="active" id="sidebar" data-csnow="2" data-class3="0" data-jsok="2">
            <dl class="list-none navnow">
                <dt id='part2_4'><a href='./community.jsp' title='所有部门' class="zm"><span>学生信息</span></a></dt>
            </dl>
            <div class="clear"></div>
        </div>
