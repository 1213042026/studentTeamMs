...
<body>
	...
	<div class="inner">
		...
		<ul class="list-none" id="list-none">
			...
			<li class="line"></li>
			<li id='nav_1' style='width:121px;' class='navdown'><a
				href='about.jsp' class='hover-none nav'><span>网站简介</span></a></li>
			<li class="line"></li>
			...
			<li class="line"></li>
			<li id='nav_5' style='width:121px;'><a href='user_info.jsp'
	...
	<div class="sidebar inner">
		<div class="sb_nav">
			...
			<div class="active" id="sidebar" data-csnow="2" data-class3="0"
				...
				<dl class="list-none navnow">
					<dt id='part2_4'>
						<a href='#' title='网站动态' class="zm"><span>网站介绍</span></a>
					</dt>
				</dl>
				<div class="clear"></div>
			</div>
		...
		<div class="sb_box">
			...
			<div class="editor active">&nbsp;&nbsp; <div id="showtext"></div><div class="clear"></div>
        </div>
    </div>
    <div class="clear"></div>
</div>
