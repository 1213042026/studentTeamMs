...
<script src="admin/js/community.js" type="text/javascript"></script>
</head>
<body>
	<header>
	<div class="inner">
		...
		<nav>
			<ul class="list-none" id="list-none">
				...
				<li class="line"></li>
				<li id='nav_1' style='width:121px;'><a href='about.jsp'ƒ
				...
				<li class="line"></li>
				<li id='nav_3' style='width:121px;' class='navdown'><a
					href='community.jsp' class='hover-none nav'><span>部门浏览</span></a></li>
				<li class="line"></li>
				<li id='nav_4' style='width:121px;'><a href='activity.jsp'><span>部门活动</span></a></li>
				<li class="line"></li>
	...
	<div class="sidebar inner">
		<div class="sb_nav">
			...
			<div class="active" id="sidebar" data-csnow="2" data-class3="0"
				...
				<dl class="list-none navnow">
					<dt id='part2_4'>
						<a href='#' title='所有部门' class="zm"><span>所有部门</span></a>
					</dt>
				</dl>
				<div class="clear"></div>
			</div>
		...
		<div class="sb_box">
			...
			<div class="active" id="newslist">
				...
				<table class="table_list" width="770px"></table>
				<div class="met_hits"></div>
			</div>
		</div>
		<div class="clear"></div>
