...
<body>
	...
	<div class="inner">
		...
		<ul class="list-none" id="list-none">
			...
			<li id='nav_3' style='width:121px;'><a href='community.jsp'
				class='hover-none nav'><span>部门浏览</span></a></li>
			<li class="line"></li>
		...
		<div class='flash flash6' style='width:980px; height:245px;'>
			<ul id='slider6' class='list-none'>
				<li><a href='#' target='_blank'><img
						src='images/community_1.jpg' width='980' height='245'></a></li>
				<li><a href='#' target='_blank'><img
						src='images/community_2.jpg' width='980' height='245'></a></li>
				<li><a href='#' target='_blank'><img
						src='images/community_3.png' width='980' height='245'></a></li>
				<li><a href='#' target='_blank'><img
						src='images/community_4.jpg' width='980' height='245'></a></li>
			</ul>
		</div>
	...
	<div class="index inner">
		<div class="aboutus style-1">
			<h3 class="title">
				<span class='myCorner' data-corner='top 5px'>网站简介</span> <a
					href="about.jsp" class="more" title="链接关键词">更多>></a>
			</h3>
		...
		<div class="case style-2">
			<h3 class='title myCorner' data-corner='top 5px'>
				<a href="community.jsp" title="链接关键词" class="more">更多>></a>部门介绍
			</h3>
		...
		<div class="index-news style-1">
			<h3 class="title">
				<span class='myCorner' data-corner='top 5px'>部门活动</span><a
		...
		<div class="index-conts style-2">
			<h3 class='title myCorner' data-corner='top 5px'>联系我们</h3>
